...
export const deployWarAllContracts = async (initialOwnerAddress: string, dealerAddress: string) => {
  const warContract = await deployWarContract(initialOwnerAddress, dealerAddress)
...
export const deployWarContract = async (initialOwnerAddress: string, dealerAddress: string) => {
