...
import { Card, Gasha, Hat } from '../typechain-types';
import { ethers } from 'hardhat';
import { SignerWithAddress } from '@nomicfoundation/hardhat-ethers/signers';
import { ContractTransactionResponse, parseEther } from 'ethers';
import { deployCardContract, deployGashaContract } from './helper';
...
describe('Gasha', () => {
  ...
  it('shoud spin', async () => {
    let amount = 10;
    await expect(
      Gasha.connect(operator).spin(amount, {
